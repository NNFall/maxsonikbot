...
def load_config() -> Config:
    ...
    return Config(
        ...
        sub_week_price_rub=int(_get_env('SUB_WEEK_PRICE_RUB', '200') or '200'),
        sub_week_price_stars=int(_get_env('SUB_WEEK_PRICE_STARS', '200') or '200'),
        sub_week_generations=int(_get_env('SUB_WEEK_GENERATIONS', '15') or '15'),
        sub_week_days=int(_get_env('SUB_WEEK_DAYS', '7') or '7'),
        sub_month_price_rub=int(_get_env('SUB_MONTH_PRICE_RUB', '500') or '500'),
        sub_month_price_stars=int(_get_env('SUB_MONTH_PRICE_STARS', '500') or '500'),
